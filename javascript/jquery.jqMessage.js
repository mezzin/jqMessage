...
(function($) {
    ...
    $.fn.extend({
		...
		// needs to be more jquery like and jquery ui support
        ...
        jqmAjaxForm: function(options) {
			if ($().ajaxForm) {
				// check if ajaxform is loaded
                var defaults = {
                ...
                if(options.jqmMessageContainer == UNDEFINED){
					var jqMessageDivName = "jqMessage_";
					if(this.id!=UNDEFINED) {
						jqMessageDivName+=this.id;
					} else {
						jqMessageDivName+=this.name;
					}
					$(this).prepend("<div id=\""+jqMessageDivName+"\"></div>");
					options.jqmMessageContainer = $("div#"+jqMessageDivName).hide();
                ...
                ajaxFormDefaults, opts.ajaxFormOptions);
